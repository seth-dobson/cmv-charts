...
logo <- image_read("STOP CMV AZ logo-white_2021.png")
...
p <- df %>%
  ...
  labs(
    ...
    LLC (@_sethdobson). <br>For more information, visit stopcmvaz.org"
  ) +
  theme_bw() +
  theme(
...
ggsave2(
  "images/cmv_awareness-vs-incidence_stop-cmv-az.png", 
  plot = combo, 
  width = 7, 
  height = 4
)
