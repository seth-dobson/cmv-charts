...
logo <- image_read("ALTO CMV AZ logo-white_2021.png")
...
p <- df %>%
  ...
  labs(
    ...
    LLC (@_sethdobson). <br>Para mas información visite altocmvaz.org"
  ) +
  theme_bw() +
  theme(
...
ggsave2(
  "images/cmv_awareness-vs-incidence_alto-cmv-az.png", 
  plot = combo, 
  width = 7.7, 
  height = 4
)
